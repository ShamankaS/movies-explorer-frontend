      ...
      <nav className={`navigation__wrapper ${visible ? 'navigation__wrapper_visible' : ''}`}>
        <ul className="navigation__items">
          <li className="navigation__item navigation__item_to-main">
            <NavLink className="navigation__item" to='/' title='На главную'>Главная</NavLink>
          </li>
        ...
        <div className="navigation__items navigation__items_auth">
          <NavLink
            to='/profile'
            className="navigation__item navigation__item-auth"
            title='Аккаунт'
          >
            Аккаунт
          </NavLink>
